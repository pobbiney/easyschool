<div class="edit-sidebar bg-white position-fixed end-0 top-0 h-100vh overflow-y-auto z-99 max-w-700-px w-100 translate-x-full duration-300 active-translate-0">
    ...
    <form method="POST" action="{{ route('update-school-class-process') }}" class="d-flex flex-column p-20">
        @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-sm-12">
                ...
                <select class="form-control form-select" name="status" id="edit_class_status">
