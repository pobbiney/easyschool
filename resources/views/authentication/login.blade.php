...
<head>
  ...
  <meta name="keywords"
    content="Education Admin Dashboard, School Admin Panel, College Dashboard, University Dashboard, LMS Dashboard, eLearning Admin Template, Student Management System, Course Management, Education Template, Study Dashboard, Online Learning Dashboard, Academic Admin Panel">
  <meta name="robots" content="INDEX,FOLLOW">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <!-- Title -->
  <title>EasySchool - School, College & LMS  </title>
        ...
        <div class="max-w-540-px mx-auto">
            ...
            <div class="mt-32 mb-32">
              ...
              @if (session('login_error_message'))
                                                 ...
                                                 @endif
            <form enctype="multipart/form-data" action="{{ route('authentication-process') }}" method="POST" class="d-flex flex-column gap-32 submit-form">
                @csrf
                <div class="d-flex flex-column gap-16">
                    <div>
                        ...
                        <input type="email" name="email" class="email-field form-control" placeholder="Enter your email" >
                    ...
                    <div>
                        ...
                        <div class="position-relative">
                            <input type="password" name="password" class="password-field form-control" placeholder="Enter your password"
                                >
