...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $linkId = DB::table('user_links')->insertGetId([
            'link_url' => 'course-registration',
            'link_name' => 'Course Registration',
            'link_target' => null,
            'link_image' => null,
            'link_parent' => $courseSetupParent->link_id,
            'page_id' => 'course',
            'page_id_sub' => 'course-registration',
            'status' => 'Active',
        ]);
    ...
    {
        $link = DB::table('user_links')->where('link_url', 'course-registration')->first();
